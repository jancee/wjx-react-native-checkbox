...
class CheckBox extends Component {
    ...
    render() {
        return (
            <TouchableOpacity onPress={this._handleToggleChecked} underlayColor={this.props.underlayColor}
                              style={styles.flexContainer}>
                <View style={this.props.containerStyle || styles.container}>
                    {this.props.labelBefore ?
                        <Label labelStyle={this.props.labelStyle} numberOfLabelLines={this.props.numberOfLabelLines}
                               label={this.props.label}/> : null}

                    {this.props.custom
                        ? this.state.checked
                            ? this.props.checkedComponent : this.props.uncheckedComponent
                        : <Image style={this.props.checkBoxStyle || styles.checkbox}
                                 source={this.state.checked ? this.props.checkedImage : this.props.uncheckedImage}/>
                    }

                    {this.props.labelBefore ? null :
                        <Label labelStyle={this.props.labelStyle} numberOfLabelLines={this.props.numberOfLabelLines}
...
CheckBox.defaultProps = {
    ...
    labelBefore: false,
    checked: false,
    checkedImage: require('./src/images/checked.png'),
    uncheckedImage: require('./src/images/unchecked.png'),
